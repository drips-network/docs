...
3. **Activate the wallet and enable the USDC Trustline**:
    ...
    * **Trustline:** You must explicitly add the "USDC" asset to your wallet (this is called "setting a trustline"). Instructions for enabling USDC on the popular LOBSTR wallet can be found [here](https://lobstr.freshdesk.com/support/solutions/articles/151000001061-adding-custom-assets-in-lobstr).
