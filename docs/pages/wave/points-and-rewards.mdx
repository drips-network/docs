...
### The Formula
Your payout is not a fixed dollar amount per issue. Instead, it is dynamic based on the total activity in the Wave.
...
**Example:**
* The Wave has a **$10,000** budget.
* The community earned a total of **5,000 Points**.
* You earned **500 Points** (10% of the total).
* Your Payout: **$1,000**.
...
2.  **Distribution**: Funds are distributed on-chain to the wallet addresses configured in the user settings.

### Requirements to Receive Funds
To ensure you receive your reward, you must meet two requirements **before the Wave ends**:
1.  **Connect a Wallet**: Set a valid address in **Settings → Payouts**.
2.  **Complete KYC**: You must complete identity verification via the link in **Settings**.
