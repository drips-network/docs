...
Each Participant may hold and use one single account on the Drips Wave App, and the KYC / KYB Check associated with that account must be completed by the natural person who actually uses it.
...
* Manipulating the Point or Wave Reward mechanisms, for example by:
    ...
    * Sharing, transferring, selling, renting, lending, or otherwise trading an account, allowing any other person to use or contribute through your account, or using an account that is used or operated by another person;
    * Completing the KYC / KYB Check on behalf of another person, using an account whose KYC / KYB Check was completed by another person, or otherwise making your verified identity or identity documents available for another person’s account;
    * Creating or using any account, identity, email address, GitHub account, wallet address, or KYC identity in order to circumvent a suspension, ban, restriction, or any other enforcement measure previously applied to you or to an account you use;
...
Sharing or trading accounts, sharing or trading KYC identities, and evading a prior suspension, ban, or other enforcement measure through a new or different account are considered particularly severe breaches of these Terms. Such breaches will ordinarily result in the permanent suspension of the Participant and forfeiture of all Points and Wave Rewards, and the Association may extend these measures to every account, identity, and wallet address it reasonably believes to be linked to the breach.
