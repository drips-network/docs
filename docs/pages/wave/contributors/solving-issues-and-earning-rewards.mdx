...
Please note that this AI-assisted functionality is **experimental**. The bot may not always assess every PR, and there is currently no way to manually request or check on an automatic limit release.
