...
Within your Safe's UI, simply navigate to the *Apps* tab and launch *Drips*. This is supported on Ethereum mainnet and https://safe.filecoin.io/, but on other networks you may need to add the respective Drips App URL as a "Custom Safe App". For example, on Optimism, click "Add custom Safe App" and enter `https://optimism.drips.network` as the URL.
